      ...
      <CardContent>
        ...
        <div className="mt-6 p-4 bg-blue-50 rounded-lg">
          ...
          <div className="text-sm text-blue-800 space-y-1">
            <p><strong>API URL:</strong> {import.meta.env.VITE_API_URL || 'https://coin-service-exchange-backend-lc1e9jblt-dhyanbhandaris-projects.vercel.app/api/v1'}</p>
            <p><strong>Environment:</strong> {import.meta.env.MODE}</p>
            <p><strong>Health URL:</strong> {import.meta.env.VITE_API_URL?.replace('/api/v1', '/health') || 'https://coin-service-exchange-backend-lc1e9jblt-dhyanbhandaris-projects.vercel.app/health'}</p>
          </div>
        </div>
